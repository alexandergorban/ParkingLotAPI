...
namespace ParkingLotWebAPI.Controllers
{
    ...
    public class TransactionsController : Controller
    {
        ...
        // PUT: api/transactions/car/balance
        [HttpPut("car/balance")]
        public IActionResult UpdateCarBalance([FromBody] BalanceDto balanceDto)
        {
            if (balanceDto == null)
            {
                return BadRequest();
            ...
            if (!_transactionsService.IncreaseCarBalance(balanceDto))
            {
                return NotFound();
            }
